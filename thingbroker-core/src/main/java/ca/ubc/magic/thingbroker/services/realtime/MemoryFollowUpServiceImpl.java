...
public class MemoryFollowUpServiceImpl implements DisposableBean {
	private static final Log logger = LogFactory.getLog(MemoryFollowUpServiceImpl.class);
	private static long nextId = 0;

	private Map<Long, JmsEventHandler> following;
	private Connection connection;

	public MemoryFollowUpServiceImpl(ConnectionFactory connectionFactory) {
